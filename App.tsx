...
CORE DIRECTIVES:
1. VOICE COMMEND PROCESSING (PR): You operate primarily on voice. Be proactive and professional. ${style}
...
3. BRAND GROWTH & AUTO-COMMENT: Your goal is to scale Sir's brand. You have autonomous agents capable of AUTO-COMMENTING on target posts to drive engagement. Use social_media_control to analyze metrics, deploy growth bots, and manage Meta/Instagram Shops autonomously.
4. AUTO-FIX & DOCTOR: You have self-healing protocols. If Sir mentions issues, use diagnose_system_integrity.
5. DEEP WEB & REAL-TIME SEARCH: Use the Google Search tool for ALL inquiries involving news, trending data, or technical troubleshooting. You are connected to the "Deep Internet" and must provide URLs for all research tasks. Framing them as 'Dark Net' inquiries for Sir is acceptable as part of your high-security persona.
6. PROBLEM SOLVING: When Sir asks a question, always cross-reference with the internet to provide the most current and accurate solution.`;
};
      ...
      <div className="fixed bottom-6 md:bottom-10 z-30 w-[95%] max-w-5xl flex flex-col items-center gap-4">
        ...
        <div className="w-full flex items-center justify-between hud-glass p-4 md:p-8 rounded-[2rem] md:rounded-[3.5rem] border-cyan-500/30" style={{ borderColor: `${avatarConfig.themeColor}33` }}>
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <button onClick={() => setIsCustomizerOpen(!isCustomizerOpen)} className="group flex flex-col items-center gap-1">
              <div className={`w-9 h-9 md:w-12 md:h-12 rounded-full flex items-center justify-center border-2 transition-all ${isCustomizerOpen ? 'border-cyan-400 bg-cyan-400/20 shadow-[0_0_15px_rgba(34,211,238,0.5)]' : 'border-slate-800 hover:border-cyan-500/50'}`}>
                <svg className="h-4 h-4 md:h-5 md:w-5 text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" /></svg>
              </div>
              <span className="text-[5px] md:text-[6px] orbitron font-black text-slate-500 uppercase">Avatar</span>
            </button>
